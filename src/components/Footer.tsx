        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col items-start gap-8">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="https://www.instagram.com/neoeng.engenharia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram da Neoeng Engenharia (@neoeng.engenharia)" className="w-11 h-11 rounded-full bg-white/5 flex items-center justify-center hover:bg-active-orange hover:text-white transition-all duration-300 shadow-sm">
