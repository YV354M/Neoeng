        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col items-start gap-8">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href="https://www.instagram.com/neoengengnharia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-11 h-11 rounded-full bg-white/5 flex items-center justify-center hover:bg-active-orange hover:text-white transition-all duration-300 shadow-sm">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/private-homes" className="text-off-white/60 hover:text-active-orange transition-colors text-sm flex items-center gap-2 group"><span className="w-1 h-1 bg-active-orange/0 group-hover:bg-active-orange rounded-full transition-all" />NeoHouse</Link></li>
